...
Bundled Server:    独立version（現行1.1.0）
...
- `0.2.0-beta.2`: 独立Event Hub管理UI、TOC2の状態表示・導線、Import／Export、SDK V2入力モード、運用診断を統合
- `1.0.0-rc.1`: 保存schemaとAction契約を固定し、更新・復元・長時間稼働を検証

Event Hubは`0.2.0`系列で段階導入し、beta.2以降の実運用結果を基にRC移行を判定する。
